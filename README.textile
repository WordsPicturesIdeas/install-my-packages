...
@install-my-packages@ is a common set of tools to get a clean server up and running like we like it.
...
@curl -L https://github.com/turbobrian/install-my-packages/raw/master/install-my-packages.sh | sh@

The more secure option is to not blindly run any foriegn code. In that case, run:

@curl -L https://github.com/turbobrian/install-my-packages/raw/master/install-my-packages.sh > install-my-packages.sh@
